...
<body>
    ...
    <form action="update_reserve.php" method="POST">
        開始日時： <input type="date" name="start_date" value="<?= $reserve->start_date ?>"><input type="time" name="start_time" value="<?= $reserve->start_time ?>"><br>
        終了日時： <input type="date" name="end_date" value="<?= $reserve->end_date ?>"><input type="time" name="end_time" value="<?= $reserve->end_time ?>"><br>
        ...
        Room No： <input type="number" name="room_no" value="<?= $reserve->room_no ?>"><br>
        メールアドレス： <input type="email" name="email" value="<?= $login_user->email ?>"><br>
        緊急連絡先： <input type="tel" name="tel" value="<?= $reserve->tel ?>"><br>
        備考/連絡事項： <input type="text" name="remarks" value="<?= $reserve->remarks ?>"><br>
